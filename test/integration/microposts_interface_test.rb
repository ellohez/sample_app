...
class MicropostSidebarTest < MicropostsInterface
  ...
  test 'should use proper pluralisation for zero microposts' do
    log_in_as(users(:malory))
    get root_path
    assert_match '0 microposts', response.body
  end

  test 'should use proper pluralisation for one micropost' do
...
class ImageUploadTest < MicropostsInterface
  test 'should have a file input field for imaages' do
    get root_path
